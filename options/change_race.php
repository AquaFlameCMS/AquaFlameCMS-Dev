    ...
    <body class="en-gb logged-in">
        ...
        <div id="layout-middle">
                    ...
                    <div id="page-content" class="page-content">
                        ...
                        <form autocomplete="off" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                if ($buscarpuntos[$method1] < $price[$method])
                                    $errors[] = "You dont have enough " . $method2;
			...
			<select id="type" name="type">';
                                    if ($price['dp'] > 0)
                                        echo '<option value="1">Donation Points</option>';
                                    if ($price['vp'] > 0)
                                        echo '<option value="2">Vote Points</option>';
                                    echo'</select>
		</div>';
                                }
                                ?>
      ...
      <button class="ui-button button1 disabled" type="submit" name="submit" id="settings-submit" value="Continue" tabindex="1" disabled="disabled">';
                                        ...
                                        echo '*One of your characters is online<br><br><button class="ui-button button1 disabled" type="submit" name="submit" id="settings-submit" value="Continue" tabindex="1" disabled="disabled">';
                                    else
                                        echo '<button class="ui-button button1" type="submit" name="submit" id="settings-submit" value="Purchase" tabindex="1">';
                                    ?>
