                        ...
                        <?php } else { ?>
                            <div id="LogPannel">
                                ...
                                <form action="?SSID:<?php echo $sessionid; ?>" method="post">
                                    <input id="accountName" name="accountName" type="text" value="Username" onfocus="if (this.value == 'Username')
                            this.value = ''" onblur="if (this.value == '')
                            this.value = 'Username'" />
                                    <input id="password" name="password" type="password" value="password" onfocus="if (this.value == 'password')
                            this.value = ''" onblur="if (this.value == '')
                            this.value = 'password'" />
