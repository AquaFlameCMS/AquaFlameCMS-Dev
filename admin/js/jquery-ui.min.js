        ...
        _daylightSavingAdjust: function(a) {
            ...
            for (var M = this._getDefaultDate(a), K = "", G = 0; G < q[0]; G++) {
                for (var N =
                    ...
                    D += '<div class="ui-datepicker-header ui-widget-header2 ui-helper-clearfix' + A + '">' + (/all|left/.test(A) && G == 0 ? h ?
...
(function(b, c) {
    b.widget("ui.progressbarA", {options: {value: 0}, min: 0, max: 100, _create: function() {
            this.element.addClass("ui-progressbar ui-widget ui-widget-content2 ui-corner-all").attr({role: "progressbar", "aria-valuemin": this.min, "aria-valuemax": this.max, "aria-valuenow": this._value()});
            this.valueDiv = b("<div class='ui-progressbar-value ui-widget-header2 ui-corner-left'></div>").appendTo(this.element);
            this._refreshValue()
        }, destroy: function() {
...
(function(b) {
    b.widget("ui.slider", b.ui.mouse, {widgetEventPrefix: "slide", options: {animate: false, distance: 0, max: 100, min: 0, orientation: "horizontal", range: false, step: 1, value: 0, values: null}, _create: function() {
            ...
            if (f.range) {
                ...
                this.range.addClass("ui-widget-header2")
            }
...
(function(b, c) {
    ...
    b.widget("ui.tabs", {options: {add: null, ajaxOptions: null, cache: false, cookie: null, collapsible: false, disable: null, disabled: [], enable: null, event: "click", fx: null, idPrefix: "ui-tabs-", load: null, panelTemplate: "<div></div>", remove: null, select: null, show: null, spinner: "<em>Loading&#8230;</em>", tabTemplate: "<li><a href='#{href}'><span>#{label}</span></a></li>"}, _create: function() {
            ...
            if (d) {
                ...
                this.list.addClass("ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header2 ui-corner-all");
            ...
            this.list.removeClass("ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header2 ui-corner-all");
