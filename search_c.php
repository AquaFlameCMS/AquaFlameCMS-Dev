            ...
            <div id="content">
                <div class="content-top">
              	...
              	<li class=""><a href="search.php?search=' . $term . '"><span class="arrow">' . $search['summ'] . '</span></a></li>';
                                    if ($num_char > 0) {
                                        echo '<li class="item-active"><a href="search_c.php?search=' . $term . '"><span class="arrow">' . $status['chars'] . ' (' . $num_char . ')' . '<span></span></span></a></li>';
                                    }
                                    if ($num_guild > 0) {
                            ...
                            <div class="search-right">
                                ...
                                <div class="helpers">
                                    <h3 class="subheader ">
                                        <?php
                                        if (!$error) {
                                            echo $search['charResults'] . '<span>' . $term . '</span>';
                                        }
                                        ?>
                                    </h3>
                                </div>
