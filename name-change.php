...
if (!isset($_POST['newname']))
    header('Location: account_log.php'); else if (!ctype_alpha($_POST['newname']))
                        ...
                        <div id="content">
                            ...
                            <div class="dashboard service">
                                <div class="primary">
                                    ...
                                    if (mysql_num_rows($realm_check) > 0)
                                        $realm_extra = mysql_fetch_assoc($realm_check);
                                    else
                                        $errors[] = "The selected realm is unavailable.";
                                    ...
                                    if (mysql_num_rows($char_check) > 0)
                                        $character = mysql_fetch_assoc($char_check);
                                    else
                                        $errors[] = "The selected character is unavailable.";

                                    if ($character['online'] == 1)
                                        $errors[] = "The selected character is online.";
                                    if ($character['account'] != $account_information['id'])
                                        $errors[] = "The selected character does not belong to you.";
                                    ?>
                                                ...
                                                <div>
                                                    ...
                                                    if (isset($_POST['payment'])) {
                                                        if ($_POST['payment'] == "pay") {
                                                            ...
                                                            if ($price['type'] == "vote") {
                                                                if ($account_extra['vote_points'] < $price['vp'])
                                                                    $errors[] = "You don't have enough vote points.";
                                                                else
                                                                    $buy = mysql_query("UPDATE users SET vote_points = vote_points - '" . $price['vp'] . "' WHERE id = '" . $account_extra['id'] . "'");
                                                            }else if ($price['type'] == "donate") {
                                                                if ($account_extra['donation_points'] < $price['dp'])
                                                                    $errors[] = "You don't have enough donation points.";
                                                                else
                                                                    $buy = mysql_query("UPDATE users SET donation_points = donation_points - '" . $price['dp'] . "' WHERE id = '" . $account_extra['id'] . "'");
                                                            }
                                                        }else {

                                                            if (empty($_POST['giftcode']))
                                                                $errors[] = "You haven't written your gift code.";
                                                            else
                                                                $errors[] = "The gift code provided is invalid.";
                                                        }
                                                        ?>
                                                            ...
                                                            <div id="payment-details">
                                                                <div>
                                                                    ...
                                                                    <fieldset class="ui-controls section-buttons">
                                                                        ...
                                                                        <?php
                                                                        if (count($errors) > 0)
                                                                            echo '<button class="ui-button button1 disabled" type="submit" id="tos-submit" tabindex="1" disabled="disabled"><span><span>Continue</span></span></button>';
                                                                        else
                                                                            echo '<button class="ui-button button1" type="submit" id="tos-submit" tabindex="1"><span><span>Continue</span></span></button>';
                                                                        ?>
