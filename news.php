                                ...
                                <div id="blog-container">
                                    ...
                                    <div id="report-post">
                                        ...
                                        <div id="report-success" style="text-align:center">
                                            <h4>Reported!</h4>
                                            [<a href="javascript:;" onclick="$( & quot; #report - post & quot; ).hide()">Close</a>]
                                        </div>
                                    </div>
                                    ...
                                    <?php if ($show_comment == true) { ?>
                                        ...
                                        <div id="page-comments">
                                            <div class="page-comment-interior" id="comments">
                                                <h3><?php echo $lang_general['comments']; ?>(<?php echo $news['comments']; ?>)</h3>
                                                                                ...
                                                                                <div class="action">
                                                                                    ...
                                                                                    <div class="submit">
                                                                                        <button class="ui-button button1 comment-submit " type="submit">
                                                                                            <span>
                                                                                                <span><?php echo $lang_general['add_a_reply']; ?></span>
                                                                                            </span>
                                                                                        </button>
                                                                                    </div>
                                                                                    <span class="clear"><!-- --></span>
                          ...
                          <a class="ui-button button1 " href="?login" onclick="return Login.open(\'loginframe.php\')"><span><span>Add a reply</span></span></a>
                                                            ...
                                                            <div class="comment <?php echo $type; ?>" id="c-<?php echo $comment['id']; ?>">
                                                                ...
                                                                <div class="comment-interior">
                                                                    <div class="character-info user">
                                                                        ...
                                                                        <?php
                                                                        if ($type == 'blizzard') {
                                                                            echo '<img src="wow/static/local-common/images/icons/employee.gif" alt="employee" />';
                                                                        }
                                                                        ?>
                                                                        <div class="user-name">
                                                                    ...
                                                                    <div class="comment-actions"><a class="reply-link" href="#c-<?php echo $comment['id']; ?>" onclick="Cms.Comments.replyTo('<?php echo $comment['id']; ?>', '<?php echo $comment['id']; ?>', '<?php echo ucfirst($userInfo['firstName']); ?>');
                                                        return false;"><?php echo $lang_general['reply']; ?></a></div>
                                                                </div>
                                                            </div>
                                                            <?php
                                                            //Get reply comments
                                                                    ...
                                                                    <div class="nested">
                                                                        <div class="comment <?php echo $type; ?>" id="c-<?php echo $replyQ['id']; ?>">
                                                                            ...
                                                                            <div class="comment-interior">
                                                                                ...
                                                                                <div class="comment-actions"><a class="reply-link" href="#c-<?php echo $comment['id']; ?>" onclick="Cms.Comments.replyTo('<?php echo $replyQ['id']; ?>', '<?php echo $comment['id']; ?>', '<?php echo ucfirst($userInfo['firstName']); ?>');
                                                                return false;"><?php echo $lang_general['reply']; ?></a></div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                            ...
                            <div id="right">
                                ...
                                <div class="sidebar-module" id="sidebar-forums">
                                    <div class="sidebar-title">
                                        <h3 class="category title-forums"><a href="#"><?php echo $lang_forums['popular_topics']; ?></a></h3>
                                    </div>
                                    <div class="sidebar-content">
