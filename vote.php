							...
							';
                                                        ...
                                                        while ($vote = mysql_fetch_array($votes)) {
                                                            ...
                                                            if (mysql_num_rows($votedx) > 0) {
                                                                ...
                                                                if (time() >= $whenIcanvote)
                                                                    ...
                                                                    if ($timp['ore'] > 0)
                                                                        if ($timp['ore'] > 1)
                                                                            $in_time = '' . $timp['ore'] . '' . $Vote['Vote24'] . '';
                                                                        else
                                                                            $in_time = '' . $timp['ore'] . '' . $Vote['Vote34'] . '';
                                                                    else if ($timp['min'] > 0)
                                                                        if ($timp['min'] > 1)
                                                                            $in_time = '' . $timp['min'] . '' . $Vote['Vote25'] . '';
                                                                        else
                                                                            $in_time = '' . $timp['min'] . '' . $Vote['Vote35'] . '';
                                                                    else if ($timp['sec'] > 0)
                                                                        if ($timp['sec'] > 1)
                                                                            $in_time = '' . $timp['sec'] . '' . $Vote['Vote26'] . '';
                                                                        else
                                                                            $in_time = '' . $timp['sec'] . '' . $Vote['Vote27'] . '';
                                                                    else
                                                                        $voteable = 1;
                                                                }
                                                            }
								...
								<div class="subsection">
									<div class="left">
										';
                                                            if ($voteable == 1)
                                                                echo '<img src="wow/static/images/services/wow/raf/en-us/step_02.jpg" alt="" />';
                                                            else
                                                                echo '<img src="wow/static/images/services/wow/raf/en-us/step_01.jpg" alt="" />';
                                                            echo'
									</div>
									...
									<div class="right">
										...
										<p>' . $vote['Description'] . '</p>';
                                                            echo '<br><br><br>';
                                                            if ($voteable == 1)
                                                                echo '<small>' . $Vote['CanVoteNow'] . '</small>';
                                                            else
                                                                echo '<small>' . $Vote['CanVoteIn'] . ' ' . $in_time . '</small>';
                                                            echo '
									</div>
								</div>
								';
