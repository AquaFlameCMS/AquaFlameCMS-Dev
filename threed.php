                                                ...
                                                <div class="under-name color-c<?php echo @$character->getObjectInfo()->class; ?>">
                                                    <span class="level"><strong><?php echo @$character->getObjectInfo()->level; ?></strong></span> <a href="#" class="race"><?php
                                                        ...
                                                        ?></a> <a id="profile-info-spec" href="#" class="spec tip"><?php
                                                                ...
                                                                ?><?php
                                                                if ($talentP <> '0') {
                                                                    echo @$armory['branch' . $talentP];
                                                                }
                                                                ?></a> <a href="#" class="class"><?php
                                    ...
                                    <div class="summary-top-inventory">
                                        <div id="summary-inventory" class="summary-inventory summary-inventory-advanced">
                                            <div class="character-3d">
                                                ...
                                                if (!mysql_num_rows($result_select_character) == 0) { // If OK
                                                                        ...
                                                                        <li class="summary-talents-0">
                                                                            <a href=""><span class="inner">
                                                                                    ...
                                                                                    <span class="roles">
                                                                                        <?php
                                                                                        if ($talentS == '750') {
                                                                                            echo '<span class="icon-tank"></span>';
                                                                                        }
                                                                                        ?>
                                                                                        <?php
//Show roles based on the talent branch
                                                                                        if ($talentS == '398' || $talentS == '839' || $talentS == '845') {
                                                                                            echo '<span class="icon-tank"></span>';
                                                                                        } elseif ($talentS == '748' || $talentS == '831' || $talentS == '760' || $talentS == '813' || $talentS == '262') {
                                                                                            echo '<span class="icon-heal"></span>';
                                                                                        } elseif ($talentS == '0') {
                                                                                            echo '<span></span>';
                                                                                        } else {
                                                                                            echo '<span class="icon-dps"></span>';
                                                                                        }
                                                                                        ?>
                                                                                    </span>
                                                                        ...
                                                                        <li class="summary-talents-1">
                                                                            <a href="" class="active"><span class="inner">
                                                                                    ...
                                                                                    <span class="roles">
                                                                                        ...
                                                                                        <?php
                                                                                        //Show roles based on the talent branch
                                                                                        if ($talentP == '398' || $talentP == '839' || $talentP == '845') {
                                                                                            echo '<span class="icon-tank"></span>';
                                                                                        } elseif ($talentP == '748' || $talentP == '831' || $talentP == '760' || $talentP == '813' || $talentP == '262') {
                                                                                            echo '<span class="icon-heal"></span>';
                                                                                        } elseif ($talentP == '0') {
                                                                                            echo '<span></span>';
                                                                                        } else {
