                            ...
                            <div class="dashboard service">
                                <div class="primary">
                                    ...
                                    <div class="service-wrapper">
                                        ...
                                        if (!$realm_extra) {
                                            echo '<meta http-equiv="refresh" content="0;url=account_log.php"/>';
                                            die();
                                        }
                                            ...
                                            <div class="service-interior">
                                                ...
                                                <div class="tos-left full-width">
                                                    <ul>
                                                        <?php
                                                        if (!$character) {
                                                            echo '<li>This character does not exist.</li>';
                                                            $disabled = 1;
                                                        }
                                                        if ($character['account'] != $account_information['id']) {
                                                            echo '<li>This character does not belong to you.</li>';
                                                            $disabled = 1;
                                                        }
                                                        ?>
                                            ...
                                            <div class="service-interior">
                                                ...
                                                <form method="POST" action="name-confirm.php">
                                                    ...
                                                    <fieldset class="ui-controls section-stacked" >
                                                        <?php
                                                        if (isset($disabled))
                                                            echo '<button class="ui-button button1 disabled" type="submit" id="tos-submit" tabindex="1" disabled="disabled"><span><span>Agree &amp; Continue</span></span></button>';
                                                        else
                                                            echo '<button class="ui-button button1" type="submit" id="tos-submit" tabindex="1"><span><span>Agree &amp; Continue</span></span></button>';
                                                        ?>
