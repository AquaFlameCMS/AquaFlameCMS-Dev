                        ...
                        <form autocomplete="off" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                if ($enewpass != $enewpass1) {
                                    die("<p align='center'>" . $Reg['Reg6'] . "<br><br>" . $Reg['Reg7'] . "<br><br>" . $Reg['Reg8'] . "</p><p align='center'><a href='change-password.php'><button class='ui-button button1' type='submit' value='back' tabindex='1'><span><span>" . $re['back'] . "</span></span></button></a></p>");
                                }
                                ...
                                if ($numrows == 0) {
                                    die("<p align='center'>" . $Reg['Reg6'] . "<br><br>" . $Reg['Reg14'] . "<br><br>" . $Reg['Reg15'] . "</p><p align='center'><a href='change-password.php'><button class='ui-button button1' type='submit' value='back' tabindex='1'><span><span>" . $re['back'] . "</span></span></button></a></p>");
                                }
