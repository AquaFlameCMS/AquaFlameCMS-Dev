                ...
                <div id="content">
                    ...
                    this.value = 'search'" />
                        ...
                        <form method="post" action="#" class="styleForm">
                            ...
                            <p>Input field<br />
                                <input name="Enter Title" type="text" value="Enter Title" class="reg" onfocus="if (this.value == 'Enter Title')
                    this.value = ''" onblur="if (this.value == '')
                    this.value = 'Enter Title'" />
                            </p>
                            <p>Input field<br />
                                <input name="Enter Title" type="text" value="Enter Title" class="med" onfocus="if (this.value == 'Enter Title')
                    this.value = ''" onblur="if (this.value == '')
                    this.value = 'Enter Title'" />
                            </p>
                            <p>Input field<br />
                                <input name="Enter Title" type="text" value="Enter Title" class="large" onfocus="if (this.value == 'Enter Title')
                    this.value = ''" onblur="if (this.value == '')
                    this.value = 'Enter Title'" />
                            </p>
                            <p>Browse<br />
                            ...
                            <p>TEXT BOX<br />
                                <textarea name="content" cols="" rows="" onfocus="if (this.value == 'Enter Content')
                    this.value = ''" onblur="if (this.value == '')
                    this.value = 'Enter Content'">Enter Content</textarea>
                                <h3>Buttons &amp; Progress bars</h3>
                                <div class="txt">
