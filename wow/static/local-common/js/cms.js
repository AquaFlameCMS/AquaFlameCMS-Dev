...
var Cms = {
    ...
    ajaxErrorInit: function(target) {
        if ($('#ajax_error').length == 0)
            $('body').append($('<div id="ajax_error"></div>'))
    ...
    Station: {
        ...
        parentToggle: function(targ, ev) {
            ...
            if (arrayLoc > -1)
                forumParentToggle.splice(arrayLoc, 1)
            else
                forumParentToggle.push(targ.toString())
    ...
    Topic: {
        ...
        topicInitIe: function() {
            $('#thread .post').bind('mouseenter', function() {
    ...
    Forum: {
        threadListInit: function() {
            $('.post-title a').bind('click', function() {
            ...
            $('.auto-expand').each(function() {
                ...
                $(this).bind('keyup', function() {
                    ...
                    $(this).height(taRef.height())
                        ...
                        .bind('focus', function() {
                    $(taRef).width(($(this).width()) * 0.98)
                })
                        .height(taRef.height())
            });

            if (Core.isIE(6)) {
                $('#page-comments .comment').bind('mouseenter', function() {
                    $(this).addClass('iehover');
                })
                        .bind('mouseleave', function() {
                    $(this).removeClass('iehover');
