                        ...
                        <div id="content">
                            <div id="page-header">
								...
								<p class="caption"><a href="account_man.php">' . $re['goPanel'] . '</a></p>
                                        ...
                                        ?>
                                        <p class="privacy-message"><b><?php echo $re['re2']; ?><?php echo $website['title']; ?> <?php echo $re['re3']; ?><a href="" onclick="window.open(this.href);
                        return false;"><?php echo $re['re4']; ?></a>.</p>
                                    </div>
                                                ...
                                                <div class="input-row input-row-checkbox input-row-important">
                                                    ...
                                                    <span class="input-right">
                                                        <label for="agreedToToU">
                                                            ...
                                                            <span class="label-text">
                                                                <?php echo $re['re36']; ?><a href="" onclick="window.open(this.href);"><?php echo $re['re37']; ?></a><?php echo $re['re38']; ?></a>
                                                                <span class="input-required">*</span>
                                                            </span>
                                                        </label>
                                                    </span>
