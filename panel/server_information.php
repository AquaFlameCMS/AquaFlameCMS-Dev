    ...
    <div class="realm-cuadro">
        <div id="sidebar-marketing" class="sidebar-module">
            ...
            if ($uptime_results['uptime'] > 2592000)
                $uptime = round(($uptime_results['uptime'] / 30 / 24 / 60 / 60), 2) . "" . $Status['Months'] . "";
            elseif ($uptime_results['uptime'] > 86400)
                $uptime = round(($uptime_results['uptime'] / 24 / 60 / 60), 2) . "" . $Status['Days'] . "";
            elseif ($uptime_results['uptime'] > 3600)
                $uptime = round(($uptime_results['uptime'] / 60 / 60), 2) . "" . $Status['Hours'] . "";
            else
                $uptime = round(($uptime_results['uptime'] / 60), 2) . "" . $Status['Min'] . "";
                ...
                <table width="300" h>
                    <tr><td width="208" height="18">
                        ...
                        <td width="80" align="left">
                            <?php echo $Status['Tipe']; ?><span class="date"><?php
                            $icon = $realm['icon'];
                            echo $type[$icon];
                            ?></span></td>
                    </tr>
