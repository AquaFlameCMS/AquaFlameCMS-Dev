                ...
                <div id="content">
                    <div class="forms">
                        <div class="heading">
                            <h2>Edit News: <?php
                                if (isset($error)) {
                                    die('<font color="red">Sorry an error has ocurred!</font>');
                                }
                                ?><?php echo $new['title']; ?></h2>
                    ...
                    this.value = 'search'" />
                        ...
                        <form method="post" action="" class="styleForm">
                            ...
                            <p>Title<br />
                                <input name="title" type="text" value="<?php echo $new['title']; ?>" class="reg" onblur="if (this.value == '')
                    this.value = '<?php echo $new['title']; ?>'" />
                            </p>
                            <div class="folder">
                                <p>Image<br />
