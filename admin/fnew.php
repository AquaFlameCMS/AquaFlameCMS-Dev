...
if (isset($_POST['save'])) {
    ...
    if ($new)
        echo '<div align="center"><font color="green">The forum has been created!</font></div><meta http-equiv="refresh" content="2;url=forums.php?id=' . intval($_POST['f_categ']) . '"/>';
    else
        echo '<div align="center"><font color="red">An error has ocurred, the forum could not has been created!</font></div>';
}
?>
                ...
                <div id="content">
                            ...
                            <table width="100%" class="table-content">
                                <tr>
                                    <td width="50%"><p><strong>Locked: </strong>
                                            ...
                                            <input type="checkbox" name="f_locked" onchange="if (this.checked) {
                    document.getElementById('is_lock').innerHTML = '<font color=red>YES</font>';
                } else {
                    document.getElementById('is_lock').innerHTML = '<font color=green>NO</font>';
                }"/>
                  ...
                  <img src='$pathimagen' width='38px' border='0' ></a></td>";  //Clik on it and the name appear on the textbox
                                ...
                                <tr><td><p><strong>Name: </strong>
                                            <input type="text" name="f_name" value="Enter Name" class="reg" onfocus="document.getElementById('error_name').innerHTML = '';
                if (this.value == 'Enter Name')
                    this.value = ''" onblur="if (this.value == '')
                    this.value = 'Enter Name'"/></p></td>
