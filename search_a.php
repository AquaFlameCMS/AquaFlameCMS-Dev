            ...
            <div id="content">
                <div class="content-top">
              	...
              	<li class=""><a href="search.php?search=' . $term . '"><span class="arrow">' . $search['summ'] . '</span></a></li>';
                                    if ($num_char > 0) {
                                        echo '<li><a href="search_c.php?search=' . $term . '"><span class="arrow">' . $status['chars'] . ' (' . $num_char . ')' . '<span></span></span></a></li>';
                                    }
                                    if ($num_guild > 0) {
                                        echo '<li><a href="search_g.php?search=' . $term . '"><span class="arrow">' . $guild['Guilds'] . ' (' . $num_guild . ')' . '<span></span></span></a></li>';
                                    }
                                    if ($num_arena > 0) {
                                        echo '<li class="item-active"><a href="search_a.php?search=' . $term . '"><span class="arrow">' . $arena['Teams'] . ' (' . $num_arena . ')' . '<span></span></span></a></li>';
                                    }
                                    if ($num_forum > 0) {
                                        echo '<li><a href="search_f.php?search=' . $term . '"><span class="arrow">' . $Forums['Forums'] . ' (' . $num_forum . ')' . '<span></span></span></a></li>';
                                    }
                                    echo '</ul>';
                                }
                                ?>
                            ...
                            <div class="search-right">
                                ...
                                <div class="helpers">
                                    <h3 class="subheader ">
                                        <?php
                                        if (!$error) {
                                            echo $search['arenaResults'] . '<span>' . $term . '</span>';
                                        }
                                        ?>
                                    </h3>
                                </div>
